...
def Template(ns):
    """Create a new Template class from source code generated by ir.TemplateNode."""
    dct = {}
...
def from_ir(ir_node):
    """Creates a template instance from Intermediate Representation TemplateNode.

    This actually creates the class defined by the TemplateNode and returns
    an instance of it. The returned object is an instance of a
    `kajiki.template._Template` subclass.
    """
